...
[assembly: MelonInfo(typeof(goofball.Main), goofball.ModHelperData.Name, goofball.ModHelperData.Version, goofball.ModHelperData.RepoOwner)]
...
namespace goofball
{
    ...
    class Main : BloonsMod
    {
        ...
        public class goofball : ModTower
        {
            public override string Name => "goofball";
            public override string DisplayName => "goofball";
            public override string Description => "goofy";
            ...
            public override string Icon => "goofball_Icon";
            public override string Portrait => "goofball_Portrait";
        }
        public class EnlargedShots : ModUpgrade<goofball>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                attackModel.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.radius = 280 * 1.1f;
            }
            public override string Icon => "EnlargedShots_Icon";
        }
        public class NadeOptimizer : ModUpgrade<goofball>
        {
        ...
        public class HeavyBlasts : ModUpgrade<goofball>
        {
        ...
        public class T101Feldhaubitz : ModUpgrade<goofball>
        {
        ...
        public class TheBigBang : ModUpgrade<goofball>
        {
            ...
            {
                AttackModel attackModel = towerModel.GetBehavior<AttackModel>();
                attackModel.weapons[0].projectile.GetBehavior<CreateProjectileOnContactModel>().projectile.radius = 800 * 1.35f;
        ...
        public class QuickdrawSight : ModUpgrade<goofball>
        {
            public override string Name => "QuickdrawSight";
            public override string DisplayName => "Quickdraw Sight";
            public override string Description => "Visual training allows goofball to target Camo Bloons.";
        ...
        public class Tenacious : ModUpgrade<goofball>
        {
        ...
        public class Adaptive : ModUpgrade<goofball>
        {
        ...
        public class BouncyShots : ModUpgrade<goofball>
        {
        ...
        public class ExplosivesSpecialist : ModUpgrade<goofball>
        {
        ...
        public class NimbleHands : ModUpgrade<goofball>
        {
        ...
        public class TacticalLobber : ModUpgrade<goofball>
        {
            public override string Name => "TacticalLobber";
            public override string DisplayName => "Tactical Lobber";
            public override string Description => "goofball shoots behind cover when the Bloons least expect it.";
        ...
        public class EMB : ModUpgrade<goofball>
        {
        ...
        public class T102Jagdfaust : ModUpgrade<goofball>
        {
        ...
        public class Zerfallen : ModUpgrade<goofball>
        {
            ...
            public static void Postfix()
            {
                ...
                try
                {
                    foreach (var tts in InGame.Bridge.GetAllTowers())
                    {
                        ...
                        if (!tts.namedMonkeyKey.ToLower().Contains("goofball")) continue;
